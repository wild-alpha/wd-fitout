...
const CarniStore = () => {
  ...
  const imageUrls = [
    { src: "/images/carnistore (1).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/carnistore (2).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/carnistore (3).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/carnistore (4).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/carnistore (5).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/carnistore (6).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/carnistore (7).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
  ];
