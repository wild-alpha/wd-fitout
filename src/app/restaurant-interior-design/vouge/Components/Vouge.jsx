...
const Vouge = () => {
  ...
  const imageUrls = [
    { src: "/images/vogue (1).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/vogue (2).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/vogue (3).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/vogue (4).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/vogue (5).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/vogue (6).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/vogue (7).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/vogue (8).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
