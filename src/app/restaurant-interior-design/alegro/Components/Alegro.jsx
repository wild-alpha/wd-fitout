...
const Alegro = () => {
  ...
  const imageUrls = [
    { src: "/images/allegro (1).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/allegro (2).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/allegro (3).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/allegro (4).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/allegro (5).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/allegro (6).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/allegro (7).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/allegro (8).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
