...
const Fujiya = () => {
  ...
  const imageUrls = [
    { src: "/images/fujiya (1).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/fujiya (2).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/fujiya (3).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/fujiya (4).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/fujiya (5).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/fujiya (6).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/fujiya (7).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/fujiya (8).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
  ];
