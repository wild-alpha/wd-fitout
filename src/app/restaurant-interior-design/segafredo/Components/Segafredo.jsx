...
const Segafredo = () => {
  ...
  const imageUrls = [
    { src: "/images/segafredo (1).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/segafredo (2).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/segafredo (3).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/segafredo (4).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/segafredo (5).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
    { src: "/images/segafredo (6).webp", alt: "Atlantis Project 1", title: "Atlantis Project 1" },
